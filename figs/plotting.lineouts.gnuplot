...
set x2range [ -3.59821 : 58.4018 ] noreverse nowriteback
set ylabel "" 
set ylabel  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set y2label "" 
set y2label  offset character 0, 0, 0 font "" textcolor lt -1 rotate by -270
set yrange [ 3389.90 : 7888.98 ] noreverse nowriteback
set y2range [ 3590.25 : 7661.64 ] noreverse nowriteback
set zlabel "" 
...
fname(x) = sprintf('tmp.%01i.dat',x)
GNUTERM = "x11"
fname = "tmp.dat"
GPFUN_fname = "fname(x) = sprintf('tmp.%01i.dat',x)"
plot fname(21) u 0:($2100+$2101+$2102+$2103+$2104+$2105),fname(22) u 0:($2100+$2101+$2102+$2103+$2104+$2105),fname(23) u 0:($2100+$2101+$2102+$2103+$2104+$2105),fname(24) u 0:($2100+$2101+$2102+$2103+$2104+$2105)
#    EOF
