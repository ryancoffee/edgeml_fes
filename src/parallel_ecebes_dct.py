...
class Params:
    def __init__(self,inpath,outpath,shot,nece=512,nbes=1024):
        ...
        self.shot = shot
        self.nsamples_ece = nece
        self.nsamples_bes = nbes

    def setnsamples_ece(self,n):
        self.nsamples_ece(nece)
        return self
    def setnsamples_bes(self,n):
        self.nsamples_bes(n)
        return self
    def getnsamples_ece(self):
        return self.nsamples_ece
    def getnsamples_bes(self):
        return self.nsamples_bes
